...
with open("proxy.txt", 'a') as file:
    ...
    file.write(httpx.get("http://worm.rip/https.txt").text)
    file.write(httpx.get("http://worm.rip/http.txt").text)
    file.write(httpx.get("https://www.proxy-list.download/api/v1/get?type=https").text)
    file.write(httpx.get("https://api.voidevs.com/v1/proxy-list?protocol=http").text)
